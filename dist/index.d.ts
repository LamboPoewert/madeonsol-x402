...
export declare class MadeOnSolREST {
     ...
     */
    deployerStats(): Promise<DeployerStatsResponse>;
    /**
     ...
     */
    deployerLeaderboard(params?: DeployerLeaderboardParams): Promise<DeployerLeaderboardResponse>;
    /**
     ...
     */
    deployerProfile(wallet: string): Promise<DeployerProfileResponse>;
    /**
     ...
     * @param wallet Deployer wallet (base58).
     */
    deployerTokens(wallet: string, params?: DeployerTokensParams): Promise<DeployerTokensResponse>;
    /**
     ...
     */
    deployerAlertStats(params?: DeployerAlertStatsParams): Promise<DeployerAlertStatsResponse>;
    /**
     ...
     */
    deployerBestTokens(params?: BestTokensParams): Promise<BestTokensResponse>;
    /**
     ...
     */
    deployerRecentBonds(params?: RecentBondsParams): Promise<RecentBondsResponse>;
    /**
     ...
     * PRO/ULTRA only.
     */
    deployerHistory(wallet: string, opts?: {
        limit?: number;
    }): Promise<DeployerHistoryResponse>;
    /**
     ...
     */
    streamSessions(): Promise<StreamSessionsResponse>;
    /**
     ...
     */
    streamSessionKill(id: number | string): Promise<StreamSessionEvictResponse>;
    /**
     ...
     */
    tokenHolders(mint: string): Promise<TokenHoldersResponse>;
    /**
     ...
     */
    tokenLocksFeed(params?: TokenLocksFeedParams): Promise<TokenLocksFeedResponse>;
    /**
     ...
     * receives HTTP 403.
     */
    tokenUnlocks(params?: TokenUnlocksParams): Promise<TokenUnlocksResponse>;
    /**
     ...
     */
    tokenFeeShares(mint: string): Promise<TokenFeeSharesResponse>;
    /**
     ...
     * 2026-08-17.** **KEYED (v1) — no x402 route.** PRO+ — BASIC receives HTTP 403.
     */
    tokenFeeClaims(params?: TokenFeeClaimsParams): Promise<TokenFeeClaimsResponse>;
    /**
     ...
     */
    tokensBatchRisk(mints: string[]): Promise<TokenBatchRiskResponse>;
    /**
