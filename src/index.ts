import type {
  ...
  TokenTradesParams,
  TokenTradesResponse,
  TokenTopTradersParams,
  TokenTopTradersResponse,
  SniperRecentParams,
  SniperRecentResponse,
} from "./types.js";
...
export type {
  ...
  TokenDepthParams,
  TokenDepthQuote,
  TokenDepthToMovePrice,
  TokenDepthPoolBase,
  TokenDepthPool,
  TokenDepthUnsupportedPool,
  TokenDepthResponse,
  TokenHolderLabel,
  TokenHolder,
  TokenHolderExcluded,
  ...
  TokenFeeEventType,
  TokenFeeShareEntry,
  TokenFeeSocialIdentity,
  TokenFeeShareholder,
  TokenFeeSharingConfig,
  TokenFeeShareHistoryEntry,
  TokenFeeDistribution,
  TokenFeeSharesResponse,
  TokenFeeClaimsParams,
  TokenFeePayout,
  TokenFeeClaimEvent,
  TokenFeeClaimsResponse,
  TokenFeeClaimStreamEvent,
  TokenSurgeKind,
  TokenSurgeTier,
  TokenSurgeBirthSource,
  TokenSurgeBaselineSource,
  TokenSurgeTapeSource,
  TokenSurgeRiskFlag,
  TokenSurgeDeployerTier,
  TokenSurgeTape,
  TokenSurgeKol,
  TokenSurgeEarlyBuyers,
  TokenSurgeDeployer,
  TokenSurgeEvent,
  TokenSurgeOutcome,
  TokenSurgeFeedEntry,
...
export class MadeOnSolX402 {
  ...
  async tokenFlow(mint: string, params?: TokenFlowParams): Promise<TokenFlowResponse> {
    return this.request(
      `/api/x402/tokens/${encodeURIComponent(mint)}/flow`,
      params as Record<string, string | number | undefined>,
    );
  }
  ...
  async tokenCandles(mint: string, params?: CandlesParams): Promise<CandlesResponse> {
    return this.request(
      `/api/x402/tokens/${encodeURIComponent(mint)}/candles`,
      params as Record<string, string | number | undefined>,
    );
  }
   ...
   */
  async tokenTopTraders(mint: string, params?: TokenTopTradersParams): Promise<TokenTopTradersResponse> {
    return this.request(
      `/api/x402/tokens/${encodeURIComponent(mint)}/top-traders`,
      params as Record<string, string | number | undefined>,
    );
  }
   ...
   */
  async sniperRecent(params?: SniperRecentParams): Promise<SniperRecentResponse> {
    return this.request("/api/x402/sniper/recent", params as Record<string, string | number | undefined>);
  }
  ...
  async deployerTrajectory(wallet: string, params?: { include?: "daily_snapshots" }): Promise<DeployerTrajectoryResponse> {
    return this.request(
      `/api/x402/deployer-hunter/${encodeURIComponent(wallet)}/trajectory`,
...
export class MadeOnSolREST {
   ...
   */
  async tokenDepth(mint: string, params?: TokenDepthParams): Promise<TokenDepthResponse> {
    return this.request("GET", `/tokens/${encodeURIComponent(mint)}/depth`, undefined,
      params?.sizes && params.sizes.length > 0 ? { sizes: params.sizes.join(",") } : undefined);
  }
   ...
   */
  async tokenHolders(mint: string): Promise<TokenHoldersResponse> {
   ...
   */
  async tokenLocksFeed(params?: TokenLocksFeedParams): Promise<TokenLocksFeedResponse> {
    const q: Record<string, string | number | undefined> = {};
    if (params) {
      for (const [k, v] of Object.entries(params)) {
        if (v === undefined || v === null) continue;
        q[k] = typeof v === "boolean" ? (v ? "1" : "0") : (v as string | number);
      }
    }
  ...
  async tokenUnlocks(params?: TokenUnlocksParams): Promise<TokenUnlocksResponse> {
    return this.request("GET", "/tokens/unlocks", undefined,
      params as Record<string, string | number | undefined>);
  }
   ...
   */
  async tokenFeeShares(mint: string): Promise<TokenFeeSharesResponse> {
   ...
   * 2026-08-17.** **KEYED (v1) — no x402 route.** PRO+ — BASIC receives HTTP 403.
   */
  async tokenFeeClaims(params?: TokenFeeClaimsParams): Promise<TokenFeeClaimsResponse> {
    return this.request("GET", "/tokens/fee-claims", undefined,
      params as Record<string, string | number | undefined>);
  }
   ...
   */
  async tokensSurges(params?: TokenSurgesParams): Promise<TokenSurgesResponse> {
    const q: Record<string, string | number | undefined> = {};
    if (params) {
      for (const [k, v] of Object.entries(params)) {
        if (v === undefined || v === null) continue;
   ...
   */
  async walletClassify(wallets: string[]): Promise<WalletBatchClassifyResponse> {
   ...
   * PRO/ULTRA only — BASIC receives HTTP 403.
   */
  async tokenTrades(mint: string, params?: TokenTradesParams): Promise<TokenTradesResponse> {
    return this.request("GET", `/tokens/${encodeURIComponent(mint)}/trades`, undefined,
      params as Record<string, string | number | undefined>);
  }
   ...
   */
  async tokenTopTraders(mint: string, params?: TokenTopTradersParams): Promise<TokenTopTradersResponse> {
    return this.request("GET", `/tokens/${encodeURIComponent(mint)}/top-traders`, undefined,
      params as Record<string, string | number | undefined>);
  }
   ...
   */
  async sniperRecent(params?: SniperRecentParams): Promise<SniperRecentResponse> {
    return this.request("GET", "/sniper/recent", undefined,
      params as Record<string, string | number | undefined>);
  }
}
